...
:: Wechselt auf das richtige Laufwerk (C:) und in deinen Kegel-Ordner
cd /d C:\Users\juppi\Documents\KEGEL_APPS\Kegeln-2b

:: Startet den Node.js Server mit automatischem Neustart (Nodemon)
nodemon server.js 

:: Falls der Server unerwartet abstürzt, bleibt das Fenster offen
echo.
